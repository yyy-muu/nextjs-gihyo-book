...
import {
  ...
  PersonIcon,
  ShoppingCartIcon,
} from '/src/components/atoms/IconButton'
import ShapeImage from '/src/components/atoms/ShapeImage'
import Spinner from '/src/components/atoms/Spinner'
import Text from '/src/components/atoms/Text'
import Box from '/src/components/layout/Box'
import Flex from '/src/components/layout/Flex'
import BadgeIconButton from '/src/components/molecules/BadgeIconButton'
import { useAuthContext } from '/src/contexts/AuthContext'
import { useShoppingCartContext } from '/src/contexts/ShoppingCartContext'
